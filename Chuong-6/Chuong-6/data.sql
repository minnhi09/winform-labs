...
-- Reset IDENTITY về 1 cho tất cả các bảng
...
VALUES 
    (N'Hóa đơn bàn T02', 2, 250000, 0.00, 0.10, 0, '1', GETDATE()),
    (N'Hóa đơn bàn VIP02', 7, 850000, 0.05, 0.10, 0, '1', GETDATE());
GO
...
VALUES 
    ...
    -- Hóa đơn 2 (Bàn VIP02)
    (2, 24, 1), -- 1 phần Lẩu thái
    (2, 12, 1), -- 1 kg Sườn nướng BBQ
    (2, 47, 2), -- 2 chai Bia Heineken
    (2, 33, 2), -- 2 ly Nước cam ép
    (2, 16, 2); -- 2 phần Kem chiên
GO
